...
export class EventsListComponent {
    // * in *ngFor tells that it is an structural directive, it can change the shape of the dom, it can add or remove elements from the dom and can change
    // its structure, it will add an structure for each item of the array
    events = [
        {
            id: 1,
